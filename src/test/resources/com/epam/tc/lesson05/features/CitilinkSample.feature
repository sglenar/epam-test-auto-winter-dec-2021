Feature: Add products to compare functionality
  ...
  Scenario: Add products to compare with starts instead if keywords
    Given I open catalog category 'СРрвыв' in 'asas' catalog
    When I add products with indexes '1,5,8' to compare list on Catalog page
